...
- [Overview](README.md)
- [What is Veilpay?](getting-started/what-is-veilpay.md)
- [Core concepts](getting-started/core-concepts.md)
- [Quickstart](getting-started/quickstart.md)
- [Current status](getting-started/current-status.md)
...
- [Consumer app architecture](architecture/consumer-app.md)
...
- [Wallet model](consumer-app/wallet-model.md)
- [Send and receive](consumer-app/send-and-receive.md)
...
- [EVM networks](chains/evm-networks.md)
...
- [Stealth addresses](privacy/stealth-addresses.md)
- [Encrypted notes](privacy/encrypted-notes.md)
- [Zero-knowledge direction](privacy/zero-knowledge.md)
- [Stellar Private Payments](privacy/stellar-spp.md)
- [Privacy-chain roadmap](privacy/privacy-chain-roadmap.md)
